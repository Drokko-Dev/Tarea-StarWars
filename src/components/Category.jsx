        ...
        <div className="category-content">
          ...
          <button
            ...
            onClick={() => {
              ...
              if (newFavorite[page]) {
                if (newFavorite[page].find((i) => i === detail.uid)) {
                  newFavorite[page] = newFavorite[page].filter(
                    (i) => i !== detail.uid,
                  );
                } else {
                  newFavorite[page] = [...newFavorite[page], detail.uid];
                }
              } else {
                newFavorite[page] = [detail.uid];
              }
          ...
          >
            {favorite[page]?.find((i) => i === detail.uid) ? (
              <svg
